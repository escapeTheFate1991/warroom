...
from app.api import chat, health, settings, auth, social, social_oauth, social_content, social_sync, files, competitors, content_intel, calendar as cal_api, google_calendar, notifications, stripe_settings, google_ai_studio, ugc_studio, video_editor, content_scheduler, video_copycat, video_assets, video_formats, content_social, carousel, auto_reply, social_accounts, mirofish, email_inbox, usage, voice, audience_intel, video_records, audience_intelligence
...
app.include_router(video_records.router, tags=["video-records"])
app.include_router(audience_intel.router, tags=["audience-intelligence"])
app.include_router(audience_intelligence.router, tags=["audience-intelligence-new"])
