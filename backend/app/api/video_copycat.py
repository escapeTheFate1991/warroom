...
@router.post("/api/video-copycat/storyboards/{storyboard_id}/generate-assets")
...
@router.get("/api/video-copycat/storyboards/{storyboard_id}/assets")
...
@router.get("/api/video-copycat/assets/{asset_id}")
...
@router.get("/api/video-copycat/assets/{asset_id}/download")
...
@router.post("/api/digital-copies/setup")
...
@router.get("/api/digital-copies/me")
...
@router.put("/api/digital-copies/me")
...
@router.post("/api/digital-copies/generate-voice")
...
@router.get("/api/digital-copies/voices")
...
@router.get("/api/video-copycat/serve/{asset_type}/{filename}")
