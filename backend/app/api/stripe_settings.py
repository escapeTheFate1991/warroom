...
SEED_PRODUCTS = [
    {
        "name": "socialRecycle Core",
        "description": "Complete social media management for growing businesses",
        "price_cents": 9900,
        "interval": "month",
        "features": [
            "AI content generation and optimization",
            "Multi-platform scheduler (Instagram, TikTok, YouTube, Facebook)",
            "Auto-reply engine for social messages",
    ...
    {
        "name": "Mirofish Add-on",
        "description": "Advanced content scoring and AI focus group analysis",
        "price_cents": 4900,
        "interval": "month",
        "features": [
            "AI-powered content feature scoring",
            "Virtual focus group (10-20 personas)",
            "Engagement velocity prediction",
            "Content performance forecasting",
            "Advanced hook and copy analysis",
