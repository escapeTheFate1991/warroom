...
SEED_PRODUCTS = [
    {
        "name": "Foundation",
        "description": "Professional website design & build with ongoing maintenance",
        "price_cents": 29900,
        "interval": "month",
        "features": [
    ...
    {
        "name": "Operational",
        "description": "Advanced SEO, Google Business, analytics, and priority support",
        "price_cents": 59900,
        "interval": "month",
        "features": [
    ...
    {
        "name": "Growth",
        "description": "AI automation, social media, lead gen, A/B testing, and dedicated account manager",
        "price_cents": 120000,
        "interval": "month",
        "features": [
